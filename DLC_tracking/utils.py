...
def remove_tracking_errors(data, likelyhood, th):
    tracking_error = np.where(likelihood < th)
    print(tracking_error)
    for error in tracking_error:
       corrected_tracking = np.delete(data(tracking_error))
