...
tdms_path = r'C:\Users\maksymilianm\Dropbox (UCL - SWC)\Project_spiders\Analysis\confined_shade_arena_escape\spider_camera_ldr(0).tdms' 
...
videofilepath = r'C:\Users\maksymilianm\Dropbox (UCL - SWC)\Project_spiders\Analysis\confined_shade_arena_escape\17_02_20_sp2.avi' 
...
def find_visual_stimuli(data, th, sampling_rate):
    ...
    ends = find_peaks_in_signal(d_filt, 1, -0.025, above=False )
    starts = find_peaks_in_signal(d_filt, 1, 0.025, above=True )[1:]
